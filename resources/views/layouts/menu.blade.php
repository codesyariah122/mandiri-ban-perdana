    ...
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('customers.*') || request()->routeIs('suppliers.*') ? 'c-show' : '' }}">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            @can('access_employees')
                <li class="c-sidebar-nav-item">
                    <a class="c-sidebar-nav-link {{ request()->routeIs('employees.*') ? 'c-active' : '' }}" href="{{ route('employees.index') }}">
                        <i class="c-sidebar-nav-icon bi bi-people-fill" style="line-height: 1;"></i> Employees
                    </a>
                </li>
            @endcan
        </ul>
