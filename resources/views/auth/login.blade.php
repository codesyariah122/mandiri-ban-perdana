...
<div class="container">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-center">
            <img width="200" src="{{ asset('images/new-logo.png') }}" alt="Logo">
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-5">
            ...
            <p class="text-center mt-5 lead">
                Developed By
                <a href="https://codesyariah-webdev.vercel.app" class="font-weight-bold text-primary">Codesyariah Webdev</a>
            </p>
        </div>
    </div>
</div>
