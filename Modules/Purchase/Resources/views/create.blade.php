                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="from-group">
                                        ...
                                        <div class="form-group" style="visibility: hidden;" id="jumlah_tempo">
                                            <label for="date_tempo">Jumlah Tempo (Hari) <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="jumlah_tempo" id="date_tempo"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
