                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-4 mb-3 mb-md-0">
                                ...
                                <div>Vehicle: {{ $customer->jenis_kendaraan }}</div>
                                <div>Number Plat: {{ $customer->plat_nomor }}</div>
                            </div>

                            <div class="col-sm-4 mb-3 mb-md-0">
                                <h5 class="mb-2 border-bottom pb-2">Employee Info:</h5>
                                <div><strong>{{ $employee->employees_name }}</strong></div>
                                <div>{{ $employee->jobdesk }}</div>
                            </div>
