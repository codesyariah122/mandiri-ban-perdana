                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="employee_id" id="employee_id" required>
                                                @foreach(\Modules\People\Entities\Employee::where('jobdesk', 'LIKE', 'Montir%')->get() as $employee)
                                                    <option value="{{ $employee->id }}">{{ $employee->employees_name }} - {{ $employee->jobdesk}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
